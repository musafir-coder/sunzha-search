...
const LANGS = {
  ...
  ing: {
    ...
    my_id:           'Са ID:',
    badge_free:      '● МУКЪА',
    badge_partial:   '● МОТТИГЕХЬ',
    badge_full:      '● ДӀАЛАьЦАЙ',
    btn_claim:       'Хьокху моттигехь Iотта лата',
    btn_leave:       'Хьокху моттигара дӀавала',
    btn_close:       'ДӀакъовла',
    you:             '(хьо)',
    since:           'хан',
    point:           'Моттиг',
    already_on:      n => `Хьо Моттиг #${n} тӀа ву/ю. Хьокхара хьалха дӀавала.`,
    full_note:       n => `Моттиг дӀалаьцай — ${n} меттиг дийзина.`,
    t_freed:         'Моттиг мукъа хилар',
    t_auto_freed:    'Хьа моттиг автоматически мукъа хилар',
    t_first_leave:   'Хьалха хьа моттигара дӀавала',
    t_just_full:     'Моттиг дӀалаьцай! Вукху моттигахь хьожа.',
    t_error:         'ГӀалат. ТӀаккха хьожа.',
    t_claimed:       n => `Хьо Моттиг #${n} тӀа`,
