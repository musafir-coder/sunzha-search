...
const LANGS = {
  ru: {
    ...
    chat_limit:        'Дневной лимит 5 сообщений исчерпан',
    goto_my_pt:        'Перейти к моей точке',
  },
  ing: {
    ...
    chat_limit:        'Дийнахьара боарам кхоачабеннаб — 5 хоам',
    goto_my_pt:        'Хьай моттига хьажа',
  }
};
